...
int main(int argc, char **argv)
    ...
    int *arr = new int [ num_of_threads ];
    ...
    while( round < num_of_rounds )
        ...
        //
        #pragma omp parallel num_threads( num_of_threads ) firstprivate(my_id, finish_msg, wake_msg, child_arr, parent_id, num_of_child) 
            {
        ...
        i = num_processes * num_of_threads - 1;
